...
const _hoisted_1$2 = { class: "oilContainer" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        unref(oilPrices).length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(oilPrices), (price) => {
          return openBlock(), createElementBlock("div", {
            class: "oiltype",
            key: price.產品名稱
          }, [
            createBaseVNode("h1", null, toDisplayString(fw(price.產品名稱)), 1),
            createBaseVNode("p", null, toDisplayString(price.參考牌價), 1)
          ]);
        }), 128)) : (openBlock(), createElementBlock("p", _hoisted_2$1, "載入中..."))
      ]);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const goToRoute = () => {
      router2.push({ name: props.toolName.replace(/\s+/g, "-").toLowerCase() });
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "tool-card",
        ...
        createBaseVNode("h1", null, toDisplayString(__props.toolName), 1),
        __props.preview ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          createVNode(oilPrice)
        ])) : createCommentVNode("", true)
      ]);
    };
  }
};
const toolCard = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-057accff"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        unref(route).path === "/" ? (openBlock(), createElementBlock("h1", _hoisted_2, "小工具集")) : createCommentVNode("", true),
        unref(route).path === "/" ? (openBlock(), createElementBlock("div", _hoisted_3, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(tools), (tool) => {
            return openBlock(), createBlock(toolCard, {
              key: tool.id,
              toolName: tool.name,
              route: tool.route,
              preview: tool.preview
            }, null, 8, ["toolName", "route", "preview"]);
          }), 128))
